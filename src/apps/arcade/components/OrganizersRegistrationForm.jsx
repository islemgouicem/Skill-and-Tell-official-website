...
const CustomRadio = ({ label, checked, name }) => (
  <label className="flex items-center gap-2 cursor-pointer">
    ...
    />
    <div
      className={`w-[18px] h-[18px] rounded-full border-2 flex items-center justify-center transition-colors ${checked ? "border-[#00D859]" : "border-white"}`}
    >
      {checked && <div className="w-2.5 h-2.5 rounded-full bg-[#00D859]" />}
    </div>
    <span
      className="text-white"
      style={{ fontFamily: "futura, sans-serif", fontSize: "16px" }}
    >
      {label}
    </span>
  </label>
...
const CustomCheckbox = ({ label, checked }) => (
  <label className="flex items-center gap-3 cursor-pointer">
    ...
    <div
      className={`w-[18px] h-[18px] border-2 flex items-center justify-center transition-colors ${checked ? "border-[#00D859]" : "border-white/80"}`}
    >
      {checked && (
...
const OrganizersRegistrationForm = () => {
  return (
    <div className="w-full flex justify-center mt-12 px-4">
      <div
        className="relative flex flex-col p-10 sm:p-14"
        style={{
          width: "1203px",
          borderRadius: "50px",
          background: "#FF00000D",
      ...
      >
        <svg
          className="absolute -top-[6px] -right-[6px] pointer-events-none"
          width="300"
          height="200"
          viewBox="0 0 300 200"
          fill="none"
        ...
        >
          <path
            d="M 160,6 L 244,6 A 50,50 0 0 1 294,56 L 294,96"
            stroke="#FF1010"
            strokeWidth="10"
            strokeLinecap="round"
          />
        ...
        <svg
          className="absolute -bottom-[6px] -left-[6px] pointer-events-none"
          width="300"
          height="200"
          viewBox="0 0 300 200"
          fill="none"
        ...
        >
          <path
            d="M 6,104 L 6,144 A 50,50 0 0 0 56,194 L 140,194"
            stroke="#FF1010"
            strokeWidth="10"
            strokeLinecap="round"
          />
        ...
        <div className="flex flex-col mb-16">
          <div className="flex items-end gap-5 mb-1">
            <img
              src="/images/arcade/personal_information.svg"
              alt="Organizers Registration"
              className="w-12 h-12"
            />
            <h2
              className="text-white m-0 tracking-wider"
              style={{
        ...
        <div className="flex flex-col gap-10 w-full z-10 relative">
          ...
          <div className="flex flex-col gap-4">
            ...
            <textarea
              ...
              className="w-full bg-[#ffffff03] border border-white/30 text-white placeholder-white/50 px-6 py-5 outline-none focus:border-white/70 transition-colors resize-none"
              style={{
                borderRadius: "30px",
          ...
          <div className="flex justify-center w-full mt-12 mb-4">
            <button
              className="px-14 py-4 rounded-[40px] text-white transition-all hover:scale-105 hover:shadow-[0_0_30px_rgba(255,0,0,0.6)]"
              style={{
                fontFamily: "compacta, sans-serif",
                fontSize: "32px",
                lineHeight: "100%",
                background:
                  "radial-gradient(ellipse at center, rgba(160,20,20,0.6) 0%, rgba(20,0,0,0.8) 100%)",
                border: "1px solid #8C1414",

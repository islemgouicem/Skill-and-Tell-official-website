                ...
                <div className="max-w-4xl mx-auto">
                    <Accordion type="single" collapsible className="w-full space-y-0">
                        {faqItems.map((item, index) => (
                            ...
                            >
                                <AccordionTrigger
                                    className="flex items-center w-full px-5 py-4 text-left text-base md:text-lg font-medium text-[#fdfdfd] hover:text-red-main-500 tracking-wide [&_img]:invert [&_img]:h-4 [&_img]:w-4"
                                >

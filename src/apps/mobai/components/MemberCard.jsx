        ...
        <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <CyberInput
                    ...
                    value={member.school_or_uni ?? ""}
                    onChange={e => handleChange("school_or_uni", e.target.value)}
                    error={errors?.school_or_uni}
                />
                <CyberInput
                    id={id("field_of_study")}
                    label="Field of Study"
                    required
                    placeholder="Field of study"
                    value={member.field_of_study ?? ""}
                ...
                <CyberSelect
                    ...
                    value={String(member.year_of_study ?? "")}
                    onChange={e => handleChange("year_of_study", e.target.value ? parseInt(e.target.value, 10) : "")}
                    error={errors?.year_of_study}
                />
                <CyberInput
                    id={id("phone_telegram")}
                    label="Telegram Phone Number"
                    required
                    placeholder="e.g. +1234567890"
                    value={member.phone_telegram ?? ""}
                    onChange={e => handleChange("phone_telegram", e.target.value)}
                    error={errors?.phone_telegram}
                />
                <CyberInput
                    id={id("email")}
                    label="Email"

        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <CyberSelect
                    ...
                    label="Worked together before"
                    required
                    placeholder="Select"
                    options={WORKED_TOGETHER_OPTIONS}
                    value={formData.worked_together_before ?? ""}
                    onChange={e => handleChange("worked_together_before", e.target.value)}
                    error={errors?.worked_together_before}
                />
            </div>
            <CyberTextarea

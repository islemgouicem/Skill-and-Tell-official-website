                ...
                return (
                  <Card
                    ...
                    className={`pointer relative frosted-glass rounded-md shadow-xl border-1 border-Main-300/60 cursor-pointer no-scrollbar
                      ...
                      ${(event.upcoming || event.path == "/arcade") ? (event.accent === 'odyssea' ? 'odyssea-event-moving-border' : 'incoming-event-moving-border') : ''}
                      `}
                    style={{
                      width: `${cardWidth}px`,
                  ...
                  >
                    {/* --- Upcoming Badge --- */}
                    {((event.upcoming || event.path == "/arcade") && isActive) && (
                      <div className="absolute top-0 right-0 z-20 overflow-hidden w-28 h-28 pointer-events-none">
                        <div className={`absolute top-5 -right-12 w-40 transform rotate-45 ${event.accent === 'odyssea' ? 'bg-[#BC9336] text-[#011B2A]' : 'bg-[#ff0000] text-white'}
                                      text-center text-xs font-bold py-1 shadow-lg animate-fade-in-down`}>
                          Upcoming
                        </div>
                      </div>
                    )}

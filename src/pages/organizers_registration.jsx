...
function OrganizerRegistration() {
    ...
    const validateForm = () => {
        ...
        if (formData.has_exp === null) formErrors.has_exp = "Please select an option for previous experience";
                ...
                <div className="max-w-5xl mx-auto w-full mb-8">
                    <div className="glass rounded-2xl p-6 md:p-8 space-y-6">
                        ...
                        <div className="input-cont grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="input-style border-none flex space-x-6 items-center">
                                    <label className="flex items-center space-x-2 text-white/80 cursor-pointer">
                                        <input
                                            ...
                                            name="has_exp"
                                            value="yes"
                                            checked={formData.has_exp === true}
                                            onChange={() => handleExperienceChange("yes")}
                                            className="form-radio text-gold checked:bg-gold/80 border-gold/50 h-4 w-4"
                                        // Added some base styling for the radio button to make it visible
                                        />
                                    ...
                                    <label className="flex items-center space-x-2 text-white/80 cursor-pointer">
                                        <input
                                            ...
                                            name="has_exp"
                                            value="no"
                                            checked={formData.has_exp === false}
                            ...
                            {(formData.has_exp === true || formData.exp_details.length > 0) && (
                                <div className='md:col-span-2'>
                                    <label className="input-label">If Yes, write us about it</label>
                                    <textarea
                                        value={formData.exp_details}
                                        onChange={(e) => {
                        ...
                        <div className="flex justify-between items-center mt-12 pt-8 border-t border-gold/50">
                            ...
                            <Button
                                ...
                                className="rounded-[10px] text-purple-1 btn-grad px-6 py-2"
                            >
                                {isSubmitting ? (
                                    <>

...
const BlackHole = () => {
    ...
    return (<div className="relative w-full h-screen overflow-hidden bg-gradient-nebula font-inter">
            <div ref={mountRef} className="w-full h-full"/>

            {/* Info Panel */}
            <div className={`absolute top-5 left-1/2 transform -translate-x-1/2 text-center text-[#EBEEFF] transition-opacity duration-2000 z-50 pointer-events-none ${showInfo ? "opacity-90" : "opacity-0"}`}>

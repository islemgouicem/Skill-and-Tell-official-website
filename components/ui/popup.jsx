...
const BouncingPopup = ({ isOpen, onClose, title = "Registration", subtitle = "Comming soon", msg = "Registration isn't open just yet, Stay tuned for an amazing experience!", color = "bg-accent-400", }) => {
    ...
    return (<div onClick={handleBackdropClick} style={{
            ...
            cursor: "pointer",
            transition: "all 0.2s"
        }} onMouseOver={e => (e.currentTarget.style.backgroundColor = "rgba(250,60%,18%,0.7)")} onMouseOut={e => (e.currentTarget.style.backgroundColor = "rgba(250,60%,18%,0.5)")}>
            ...
            inset: 0,
            borderRadius: "9999px",
            background: "linear-gradient(135deg, hsl(25,100%,60%), hsl(25,100%,70%))",
            opacity: 0.6,
            filter: "blur(10px)"
        }}/>
                            <div className={`${color == null ? "bg-accent-500" : color}`} style={{
            position: "relative",
            borderRadius: "9999px",
            padding: "1rem",
            display: "flex",
            ...
            animationDelay: "0.4s"
                    ...
                    {/* Action button */}
                    <button onClick={handleClose} className="text-white bg-red-main-500" style={{
            width: "100%",

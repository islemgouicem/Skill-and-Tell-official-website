...
export default function NotFound() {
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#22003D] px-6">
      {/* Background glow */}
      ...
      <div className="relative w-full max-w-xl rounded-3xl border border-violet-500/50 bg-[#2b0447]/80 p-12 text-center shadow-[0_0_50px_rgba(168,85,247,.25)] backdrop-blur-xl">
        ...
        <Link
          href="/"
          className="mt-10 inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-orange-500 to-orange-600 px-7 py-3 font-semibold text-white transition hover:scale-105"
        >
          <Home size={18} />
          Back to Home
        </Link>

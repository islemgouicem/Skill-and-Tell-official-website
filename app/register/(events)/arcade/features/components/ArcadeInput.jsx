...
const ArcadeInput = ({ label, className, error, required = true, ...props }) => {
    return (<div className="arcade-field-container flex flex-col gap-3 w-full">
      ...
      <input aria-invalid={Boolean(error)} className={cn("arcade-form-input w-full font-futura transition-colors focus:outline-none placeholder:text-white/70", className)} style={{

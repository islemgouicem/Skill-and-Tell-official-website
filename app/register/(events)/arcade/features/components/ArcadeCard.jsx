...
const ArcadeCard = ({ title, icon, children, className, size = "md", cardHeight, radius, contentPadding, topRightCorner, bottomLeftCorner, cornerSize, cornerTopOffset, cornerSideOffset, cornerScale, }) => {
    ...
    return (<>
      ...
      `}</style>
      <div data-arcade-card-size={size} className={cn("relative overflow-visible", className)} style={{
            height: resolvedCardHeight,
            minHeight: resolvedCardHeight,
            background: "rgba(255, 0, 0, 0.01)",
            border: "1px solid #8C1414",
            boxShadow: "inset 0px 0px 20px rgba(255, 114, 114, 0.4), 0px 0px 22px rgba(255, 7, 7, 0.18)",
            backdropFilter: "blur(10px)",
            WebkitBackdropFilter: "blur(10px)",
            borderRadius: resolvedRadius,
        }}>
      <img src={resolvedTopRightCorner} alt="" aria-hidden="true" className="pointer-events-none absolute right-0 top-0 hidden select-none sm:block" style={{
      ...
      <img src={resolvedTopRightCornerMobile} alt="" aria-hidden="true" className="pointer-events-none absolute right-0 top-0 select-none sm:hidden" style={{
      ...
      <img src={resolvedBottomLeftCorner} alt="" aria-hidden="true" className="pointer-events-none absolute bottom-0 left-0 hidden select-none sm:block" style={{
            width: resolvedCornerSize,
            height: "auto",
            opacity: 0.96,
      ...
      <img src={resolvedBottomLeftCornerMobile} alt="" aria-hidden="true" className="pointer-events-none absolute bottom-0 left-0 select-none sm:hidden" style={{
            width: resolvedMobileCornerSize,
            height: "auto",
            opacity: 0.96,
      ...
      <div className={cn("arcade-card-content relative z-10 flex h-full flex-col", resolvedContentPadding)}>
        {/* Header */}
        {title && (<div className="mb-6 sm:mb-10">
            <div className="mb-1 flex items-center gap-2 sm:gap-3">
              ...
              <h3 className="arcade-card-title-text font-compacta leading-none text-white tracking-[0.06em]" style={{ fontSize: variant.titleSize, lineHeight: 0.95 }}>
                {title}
              </h3>
            </div>
            <div className="arcade-card-title-line mt-1" style={{
                height: "1px",
                borderRadius: "50px",
            }}/>
          </div>)}

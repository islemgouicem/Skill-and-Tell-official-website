...
const Organizers = () => {
    return (<section className="relative w-full overflow-hidden pb-10 pt-20" id="organizers">
            {/* Title */}
            ...
            <Image height={400} width={300} className="absolute top-2 right-2 w-20 h-auto -rotate-90
            sm:top-3 sm:right-4 sm:w-24
            md:top-4 md:right-6 md:w-32
            lg:top-5 lg:right-5 lg:w-40" alt="Group" src="/images/corners.svg"/>
            <Image height={400} width={300} className="absolute bottom-2 left-2 w-20 h-auto rotate-90

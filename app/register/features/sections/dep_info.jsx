...
export default function DepartmentInfo() {
    ...
    return (<div className="space-y-6 animate-fade-in-up">
            <div className="text-center mb-8">
                <img src="/icons/department.svg" alt="User Icon" className="w-12 h-12 sm:w-16 sm:h-16 md:w-[70px] md:h-[70px] mx-auto mb-4"/>
            ...
            <div className="space-y-6 px-2 md:px-10">
                ...
                <div>
                    ...
                    <CosmicSelect placeholder="Select your First Choice" options={departments} value={formData.dep1} onValueChange={value => handleSelectChange("dep1", value)} required/>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <CosmicSelect placeholder="Select your First Choice" options={departments} value={formData.dep2} onValueChange={value => handleSelectChange("dep2", value)} required/>
                    ...
                    <div>
                        ...
                        <CosmicSelect placeholder="Select your First Choice" options={departments} value={formData.dep3} onValueChange={value => handleSelectChange("dep3", value)} required/>

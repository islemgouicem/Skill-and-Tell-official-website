...
const DepartmentTestSection = () => {
    return (<section className="relative h-screen min-h-[600px] overflow-hidden flex items-center">
            {/* Gradient background */}
            ...
            <div className="absolute inset-0 pointer-events-none overflow-hidden">
                ...
                <div className="absolute top-[10%] left-[5%] font-mono text-[10px] md:text-xs leading-relaxed opacity-80" style={{ animation: "float 6s ease-in-out infinite" }}>
                ...
                <div className="absolute bottom-[10%] left-[5%]" style={{
            ...
            animationDelay: "0.5s"
                ...
                <div className="absolute top-[60%] right-[8%]" style={{
            animation: "float 6s ease-in-out infinite",
            animationDelay: "2.5s"
        }}>
                    <svg className="w-12 h-12 md:w-16 md:h-16" viewBox="0 0 64 64">
                        {/* Target rings */}
                        <circle cx="32" cy="32" r="28" fill="none" stroke="#FB923C" strokeWidth="2" opacity="0.3"/>
                        <circle cx="32" cy="32" r="20" fill="none" stroke="#FB923C" strokeWidth="2" opacity="0.5"/>
                        <circle cx="32" cy="32" r="12" fill="none" stroke="#FB923C" strokeWidth="2" opacity="0.7"/>
                        <circle cx="32" cy="32" r="4" fill="#FB923C"/>
                        {/* Arrow */}
                        <line x1="48" y1="16" x2="36" y2="28" stroke="#FB923C" strokeWidth="2"/>
                        <polygon points="50,12 52,20 44,18" fill="#FB923C"/>
                    </svg>
                </div>

                {/* Floating sparkles */}
                <div className="absolute top-[5%] right-[40%] w-2 h-2 bg-white rounded-full animate-pulse shadow-[0_0_10px_white]" style={{ animationDelay: "0s" }}/>
                <div className="absolute bottom-[40%] left-[25%] w-1.5 h-1.5 bg-[#A78BFA] rounded-full animate-pulse shadow-[0_0_8px_#A78BFA]" style={{ animationDelay: "0.5s" }}/>
                <div className="absolute top-[35%] right-[30%] w-1 h-1 bg-[#2DD4A8] rounded-full animate-pulse shadow-[0_0_6px_#2DD4A8]" style={{ animationDelay: "1s" }}/>
            </div>
            ...
            <div className="container relative z-10 mx-auto px-6 h-[55%] flex justify-center">
                <div className="max-w-2xl flex flex-col items-center justify-between mx-auto text-center">
                    ...
                    <div className="inline-flex items-center gap-3 mb-6">
                        ...
                        <span className="text-xs uppercase tracking-[0.3em] text-[#A78BFA] font-semibold" style={{ fontFamily: "'Poppins', sans-serif" }}>
                            BY Skill&Tell
                        </span>
                    ...
                    {/* Title */}
                    <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight" style={{ fontFamily: "'Poppins', sans-serif" }}>
                        Where Do{" "}
                        <span className="relative inline-block">
                            ...
                            <svg className="absolute -bottom-2 left-0 w-full" viewBox="0 0 100 12" preserveAspectRatio="none">
                                <path d="M0 8 Q25 0 50 8 Q75 12 100 6" stroke="url(#underlineGradient)" strokeWidth="3" fill="none" strokeLinecap="round"/>
                                <defs>
                    ...
                    {/* Description */}
                    <p className="text-gray-400 text-lg md:text-xl mb-10 leading-relaxed max-w-lg mx-auto" style={{ fontFamily: "'Poppins', sans-serif" }}>
                        Discover your ideal department through our personality-based
                        assessment.
                    </p>

                    {/* Console-style CTA button */}
                    <Link href="https://departments-test.vercel.app/" target="_blank" rel="noopener noreferrer" className="group inline-flex items-center">
                        <div className="relative px-8 py-4 rounded-xl border-2 border-[#8B5CF6] bg-[#8B5CF6]/10 hover:bg-[#8B5CF6] hover:border-[#8B5CF6] transition-all duration-300 group-hover:shadow-[0_0_40px_rgba(139,92,246,0.5)]">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-white font-semibold tracking-wide text-lg" style={{ fontFamily: "'Poppins', sans-serif" }}>
                                    Take the Test
                                </span>
                    ...
                    {/* Minimal stats */}
                    <div className="flex items-center justify-center gap-6 mt-10 text-sm text-gray-500" style={{ fontFamily: "'Poppins', sans-serif" }}>

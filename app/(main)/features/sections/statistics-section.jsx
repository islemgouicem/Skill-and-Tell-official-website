...
const AnimatedNumber = ({ value, isVisible, delay }) => {
    ...
    return (<p className="text-accent-300 font-futura_bold" style={{
...
function StatisticsSection() {
    ...
    const stats = [
        {
            value: "5+",
            label: "Annual Events",
            description: "We organize exciting events every year—from hands-on workshops to national competitions—bringing innovation and collaboration to life.",
        },
        {
            value: "200+",
    ...
    return (<section id="statistics" ref={sectionRef} style={{
            position: "relative",
      ...
      <div style={{
        ...
        <div style={{
          ...
          {stats.map((stat, index) => {
            ...
            return (<div key={index} onMouseEnter={(e) => {
                    ...
                    transition: `transform 0.4s ease-in-out, box-shadow 0.4s ease-in-out, opacity 0.8s ease-out ${200 + index * 100}ms`, // Smooth transition for elevation, shadow, and animation
                ...
                <p className="font-futura_md_bt text-neutral-500" style={{

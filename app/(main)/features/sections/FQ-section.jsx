...
function FQ() {
    return (<section id="FQ" className="relative py-12 md:py-18 bg-space-dark text-space-text overflow-hidden" style={{
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="max-w-3xl mx-auto mt-6 py-0">
          <Accordion type="single" collapsible className="w-full">
            {faqItems.map((item) => (<div key={item.value}>
          ...
          data-[state=open]:text-Main-300">
                    <div className="flex items-center text-sm sm:text-base md:text-lg">
                      <Image src={snt} alt="Logo" className="h-15 w-15 md:h-15 md:w-15 flex-shrink-0"/>
                      {item.question}
                    </div>

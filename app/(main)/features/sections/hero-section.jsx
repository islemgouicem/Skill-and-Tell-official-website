...
import Shield from "../../../../components/ui/shield_badge";
import PopUp from "../../../../components/ui/popup";
import { Avatar, AvatarImage, AvatarFallback } from "../../../../components/ui/avatar";
import Image from "next/image";
// import HeroSpline from "../../../../components/ui/spline_3d";
...
export default function HeroSection() {
    ...
    return (<section id="hero" className="relative h-screen flex items-center justify-center text-center text-space-text bg-cover bg-top bg-no-repeat" style={{
      ...
      <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-full z-10 pointer-events-none">
        <Image src="/purpleplanet.png" // replace with your image path
     alt="Hero" height={400} width={300} className="w-full h-auto max-h-[90vh] md:max-h-[60vh] lg:max-h-[30vh] object-contain"/>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center px-4 translate-y-[-70px] sm:translate-y-0 animate-fade-in-up">
        ...
        text-space-text drop-shadow-lg">
          ...
          <span className="text-space-accent" style={{
            color: "#422352",

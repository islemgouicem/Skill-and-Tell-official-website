...
export default function Footer() {
    return (<footer id="contacts" className="bg-footer-background text-footer-text pt-12 md:pt-16 relative overflow-hidden">
      <div className="container max-w-[1600px] mx-auto px-8 md:px-14 grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
        ...
        <div className="lg:col-span-1 space-y-4">
          <a href="https://www.instagram.com/skillntell.club?igsh=MTFzZ3dpMTY2cGV5bg==" className="socialm" target="_blank" rel="noopener noreferrer">
          ...
          <button type="button" className="socialm cursor-not-allowed opacity-70" disabled>
            <img src="/icons/Discord.svg" className="h-5 w-5" alt="discord"/>
            <span className="font-medium text-neutral-300">Discord coming soon</span>
          </button>
          <a href="https://www.linkedin.com/company/skill-tell-club/" className="socialm" target="_blank" rel="noopener noreferrer">
          ...
          <a href="mailto:skill.and.tell@ensia.edu.dz" className="socialm">

...
const Organizers = () => {
    ...
    return (<section className="relative  w-full overflow-visible mb-10 flex flex-col justify-center items-center" id="organizers">
            ...
            <div className="w-[95%] sm:w-[85%] md:w-[82%] lg:w-[90%] flex gap-[0.5rem] flex-col justify-center items-start px-4 md:px-8 lg:px-16">
                <div className="relative w-full flex justify-between items-start sm:items-center">
                    <div className="flex flex-col justify-between items-start w-full sm:w-auto">
                        ...
                        <TheRedButton textContent={"APPLY NOW"} pageName={handleOpenPopup} //
     className="scale-[0.82] sm:scale-100 origin-left" textClassName="text-[1.8rem] sm:text-4xl"/>
                    </div>

                    <Image width={300} height={400} src="/images/arcade/organizers_soldiers.png" alt="" className="z-10 sm:hidden pointer-events-none absolute -right-6 top-[3rem] w-[12rem]"/>

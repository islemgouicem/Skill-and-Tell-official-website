...
const SuccessState = ({ onBackHome }) => (<ArcadeCard size="lg" cardHeight="min(440px, calc(100vh - 170px))" contentPadding="px-4 sm:px-6 py-2 sm:py-4" className="arcade-success-card mt-0 mx-auto w-[92%] sm:w-[78%] lg:w-[66%]">
    <div className="arcade-success-inner relative flex flex-1 w-full flex-col text-center sm:gap-5">
      <img src={registrationHand} alt="" aria-hidden="true" className="arcade-success-decor-reg1-a absolute left-[12%] top-[12%] -translate-x-1/2 -translate-y-1/2" style={{ width: "clamp(124px, 11vw, 162px)" }}/>
      <img src={registrationHand} alt="" aria-hidden="true" className="arcade-success-decor-reg1-b absolute left-[18%] top-[26%] -translate-x-1/2 -translate-y-1/2" style={{ width: "clamp(114px, 10vw, 150px)" }}/>
      <img src={slashHand} alt="" aria-hidden="true" className="arcade-success-decor-reg2-a absolute right-[16%] bottom-[24%] translate-x-1/2 translate-y-1/2" style={{ width: "clamp(110px, 10vw, 146px)" }}/>
      <img src={slashHand} alt="" aria-hidden="true" className="arcade-success-decor-reg2-b absolute right-[10%] bottom-[10%] translate-x-1/2 translate-y-1/2" style={{ width: "clamp(104px, 10vw, 140px)" }}/>

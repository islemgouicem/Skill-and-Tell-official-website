        ...
        >
            <div
                style={{
                    ...
                    borderRadius: "1rem",
                    background:
                        `linear-gradient(145deg, ${arcade.deep}, ${arcade.dark})`,
            ...
            >
                ...
                >
                    ...
                    <button
                        ...
                        onMouseOver={e =>
                            (e.currentTarget.style.backgroundColor = "rgba(169,86,42,0.24)")
                        }
                        onMouseOut={e =>
                            (e.currentTarget.style.backgroundColor = "rgba(169,86,42,0.12)")
                        }
                    >
                        ...
                        <div style={{ position: "relative" }}>
                            <div
                                style={{
                                    ...
                                    borderRadius: "9999px",
                                    background:
                                        "linear-gradient(135deg, rgba(169,86,42,0.7), rgba(199,120,78,0.6))",
                                    opacity: 0.45,
                                    filter: "blur(10px)"
                                }}
                            />
                    ...
                    <RedButton
                        textContent="Got it!"
                        pageName={handleClose}
                        className="mx-auto scale-[0.88] sm:scale-95"

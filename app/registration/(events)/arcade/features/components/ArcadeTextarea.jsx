...
const ArcadeTextarea = ({ label, className, textareaStyle, error, showErrorState = true, required = true, ...props }) => {
    ...
    return (<div className="arcade-field-container flex flex-col gap-3 w-full">
      ...
      <textarea aria-invalid={Boolean(error)} className={cn("arcade-form-textarea w-full font-futura transition-colors focus:outline-none resize-none placeholder:text-white/70", className)} style={{

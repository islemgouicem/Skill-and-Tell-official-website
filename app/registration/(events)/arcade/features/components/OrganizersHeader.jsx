...
const OrganizersHeader = () => {
    return (<div className="flex flex-col items-center justify-center pt-[44px]">
      <h1 className="text-center text-white m-0" style={{
      ...
      <div className="border-t border-white" style={{
            width: "1159px",
            maxWidth: "90vw",
            height: "0px",
            opacity: 1,

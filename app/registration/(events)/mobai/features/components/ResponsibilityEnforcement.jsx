...
const ResponsibilityEnforcement = ({ members }) => {
    ...
    return (<div className="mt-6 pt-6 border-t border-red-main-500/30">
            ...
            {!hasSixMembers && (<p className="text-red-main-500 text-xs mt-2">
                    * You must have exactly 6 team members.
                </p>)}
            {!allCovered && hasSixMembers && (<p className="text-red-main-500 text-xs mt-2">

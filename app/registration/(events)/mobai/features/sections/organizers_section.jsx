...
const Organizers = () => {
    ...
    return (<section id="organizers" className="relative pt-16 pb-10 w-full overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="flex flex-col items-center text-center max-w-2xl mx-auto">
                    ...
                    {/* APPLY NOW! button */}
                    <CyberButton variant="primary" onClick={handleOpenPopup} //() => navigate("/mobai/organizers")

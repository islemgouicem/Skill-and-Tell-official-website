...
function IdeathonRegistration() {
    ...
    const validateStep = async () => {
        ...
        if (currentStep === 1) {
            ...
            if (!formData.teamName.trim())
                stepErrors.teamName = "Please enter the Team Name";
            // Leader Validation (Registration 1.png)
            if (!formData.leaderName.trim())
                stepErrors.leaderName = "Leader's Full Name is required";
            if (!formData.leaderEmail.trim() || !emailRegex.test(formData.leaderEmail))
                stepErrors.leaderEmail = "Please enter a valid Email address";
            if (!formData.leaderPhone.trim() || !phoneRegex.test(formData.leaderPhone))
                stepErrors.leaderPhone = "Please enter a valid Phone number";
            if (!formData.leaderUniversity.trim())
                stepErrors.leaderUniversity = "Please enter your University";
        }
        if (currentStep === 2) {
            ...
            requiredMembers.forEach((member, index) => {
                ...
                if (!member.fullName.trim())
                    memberErr.fullName = "Full name is required";
                if (!member.email.trim() || !emailRegex.test(member.email))
                    memberErr.email = "Valid email is required";
                if (!member.university.trim())
                    memberErr.university = "University is required";
                if (!member.phone.trim() || !phoneRegex.test(member.phone))
                    memberErr.phone = "Valid phone number is required";
            ...
            if (optionalMember) {
                ...
                if (isMemberFilled) {
                    ...
                    if (!optionalMember.fullName.trim())
                        memberErr.fullName = "Full name is required";
                    if (!optionalMember.email.trim() || !emailRegex.test(optionalMember.email))
                        memberErr.email = "Valid email is required";
                    if (!optionalMember.university.trim())
                        memberErr.university = "University is required";
                    if (!optionalMember.phone.trim() || !phoneRegex.test(optionalMember.phone))
                        memberErr.phone = "Valid phone number is required";
                    if (Object.keys(memberErr).length > 0) {
        ...
        if (currentStep === 3) {
            ...
            if (!formData.teamMotivation.trim() || formData.teamMotivation.trim().length < 50)
                stepErrors.teamMotivation = "Motivation must be at least 50 characters.";
        }
    ...
    const renderMemberForm = (member, index) => {
        ...
        return (<div key={index} className="space-y-6">
                <div className="border p-4 rounded-lg border-Main-500/50 bg-space-light/5 backdrop-blur-sm">
                    ...
                    {(!isRequiredMember) && (<div className='flex justify-end -mt-2 -mr-2'>
                            <Button onClick={() => removeMember(index)} variant="ghost" className="text-error-200 hover:text-error-300 hover:bg-space-light/20 p-2 h-auto">
                    ...
                    <div className="flex items-center space-x-2 mb-4 mt-2">
                        <img src="/icons/Profile.svg" alt="Member Icon" className="w-8 h-8"/>
                    ...
                    <div className="input-cont grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" value={member.fullName} ref={el => fieldRefs.current[`members.${index}.fullName`] = el} onChange={(e) => handleMemberChange(index, "fullName", e.target.value)} className="input-style" placeholder="Enter your full name" required={isRequiredMember}/>
                        ...
                        <div>
                            ...
                            <input type="email" value={member.email} ref={el => fieldRefs.current[`members.${index}.email`] = el} onChange={(e) => handleMemberChange(index, "email", e.target.value)} className="input-style border-gold" placeholder="Enter your email" required={isRequiredMember}/>
                        ...
                        <div>
                            ...
                            <input type="tel" value={member.phone} ref={el => fieldRefs.current[`members.${index}.phone`] = el} onChange={(e) => handleMemberChange(index, "phone", e.target.value)} className="input-style" placeholder="Enter your phone number" required={isRequiredMember}/>
                        ...
                        <div>
                            ...
                            <input type="text" value={member.university} ref={el => fieldRefs.current[`members.${index}.university`] = el} onChange={(e) => handleMemberChange(index, "university", e.target.value)} className="input-style" placeholder="Select your university" required={isRequiredMember}/>
                        ...
                        <div>
                            ...
                            <input type="url" value={member.linkedin} onChange={(e) => handleMemberChange(index, "linkedin", e.target.value)} className="input-style" placeholder="Enter your linkedin" required={isRequiredMember}/>
                        ...
                        <div>
                            ...
                            <input type="url" value={member.github} onChange={(e) => handleMemberChange(index, "github", e.target.value)} className="input-style" placeholder="Enter your github" required={isRequiredMember}/>
    ...
    return (<div className="min-h-screen p-2 bg-cover bg-center bg-repeat" style={{ backgroundImage: "url('/images/eunoia_registeration.png')" }}>
            ...
            <div className="max-w-5xl mx-auto my-6">
                <div className="glass rounded-2xl p-6 md:p-8">
                    ...
                    {currentStep === 1 && (<div className="space-y-8 animate-fade-in-up">
                            <div className="flex items-center mb-8">
                                ...
                                <div className="bg-gold/30 w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 rounded-full flex items-center justify-center mr-4">
                                    <img src="/images/team.svg" alt="Team Icon" className="w-8 h-8 sm:w-16 sm:h-16 md:w-12 md:h-12"/>
                                </div>
                            ...
                            <fieldset className="space-y-6 border p-4 rounded-lg border-Main-500/50 bg-space-light/5 backdrop-blur-sm">
                                ...
                                <div className="input-cont grid grid-cols-1 gap-4">
                                    <div>
                                        ...
                                        <input type="text" value={formData.teamName} onChange={(e) => handleInputChange("teamName", e.target.value)} className="input-style" ref={el => fieldRefs.current["teamName"] = el} placeholder="Enter your team name" required/>
                            ...
                            <fieldset className="space-y-6 border p-4 rounded-lg border-Main-500/50 bg-space-light/5 backdrop-blur-sm">
                                ...
                                <div className="input-cont grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        <label className="input-label">Full Name <Star /></label>
                                        <input type="text" value={formData.leaderName} onChange={(e) => handleInputChange("leaderName", e.target.value)} className="input-style" placeholder="Enter your full name" required ref={el => fieldRefs.current["leaderName"] = el}/>
                                    ...
                                    <div>
                                        <label className="input-label">Email <Star /></label>
                                        <input type="email" value={formData.leaderEmail} onChange={(e) => handleInputChange("leaderEmail", e.target.value)} className="input-style" placeholder="Enter your email" required/>
                                    ...
                                    <div>
                                        <label className="input-label">Phone Number <Star /></label>
                                        <input type="tel" value={formData.leaderPhone} onChange={(e) => handleInputChange("leaderPhone", e.target.value)} className="input-style" placeholder="Enter your phone number" required/>
                                    ...
                                    <div>
                                        <label className="input-label">University <Star /></label>
                                        <input type="text" value={formData.leaderUniversity} onChange={(e) => handleInputChange("leaderUniversity", e.target.value)} className="input-style" placeholder="Select your university" required/>
                                    ...
                                    <div>
                                        <label className="input-label">LinkedIn</label>
                                        <input type="url" value={formData.leaderLinkedin} onChange={(e) => handleInputChange("leaderLinkedin", e.target.value)} className="input-style" placeholder="Enter your linkedin" required/>

                                    </div>
                                    {/* Leader GitHub */}
                                    <div>
                                        <label className="input-label">Github</label>
                                        <input type="url" value={formData.leaderGithub} onChange={(e) => handleInputChange("leaderGithub", e.target.value)} className="input-style" placeholder="Enter your github" required/>
                    ...
                    {currentStep === 2 && (<div className="space-y-8 animate-fade-in-up">
                            <div className="flex items-center mb-8">
                                {/* Icon */}
                                <div className="bg-gold/30 w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 rounded-full flex items-center justify-center mr-4">
                                    <img src="/images/team.svg" alt="Team Icon" className="w-8 h-8 sm:w-16 sm:h-16 md:w-12 md:h-12"/>
                    ...
                    {currentStep === 3 && (<div className="space-y-8 animate-fade-in-up">
                            {/* title */}
                            <div className="flex items-center mb-8">
                                {/* Icon */}
                                <div className="bg-gold/30 w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 rounded-full flex items-center justify-center mr-4">
                            ...
                            <div className='md:col-span-2'>
                                ...
                                <textarea value={formData.teamMotivation} ref={el => fieldRefs.current["teamMotivation"] = el} onChange={(e) => {
                handleInputChange("teamMotivation", e.target.value);
                e.target.style.height = "auto";
                e.target.style.height = e.target.scrollHeight + "px";
            }} className="input-style resize-none textarea-responsive overflow-hidden" placeholder="Describe your team's goal and motivation for joining the ideathon." required/>
                    ...
                    <div className="flex justify-between items-center mt-12 pt-8 border-t border-space-subtle">
                        ...
                        {currentStep < totalSteps ? (<Button onClick={nextStep} className="btn-grad rounded-sm text-purple-1 hover:from-space-orange-light hover:to-space-purple">
                                Next
                                <ArrowRight className="w-5 h-5 ml-2"/>
                            </Button>) : (<Button onClick={submitForm} disabled={isSubmitting} className="rounded-[10px] text-purple-1 btn-grad px-4 lg:px-8">
                            {isSubmitting ? (<>

...
export default function HeroSection() {
    ...
    return (<section id="home" className="relative w-full pt-[80px] min-h-screen overflow-hidden flex">
            ...
            <div className="flex flex-col justify-between items-center w-full min-h-[calc(100vh-80px)] relative z-20">
                ...
                <Image width={300} height={400} className="absolute top-10 left-[198px] w-[320px] h-[320px] hidden lg:block z-10" alt="Ellipse" src="/images/circle.svg"/>
                <Image width={300} height={400} className="absolute top-60 left-[460px] w-1 h-[161px] hidden lg:block" alt="Line" src="/images/vertical_line.svg"/>
                <Image width={300} height={400} className="absolute rotate-45 top-[300px] left-[990px] w-[116px] h-[116px] hidden lg:block" alt="Line" src="/images/vertical_line.svg"/>

                {/* MAIN CONTENT */}
                <div className="flex flex-col justify-between items-center h-[90%] sm:h-full gap-12 pt-10 px-4 max-w-6xl w-full">
                    <Image width={300} height={400} className="w-[280px] sm:w-[300px] md:w-[320px] mt-8 mb-4" alt="Logo PNG" src="/images/eunoia.svg"/>
    ...
    className="btn-grad px-8 py-5 sm:px-10 sm:py-6 rounded-[10px] text-xl sm:text-2xl text-purple-1 shadow-[0px_4px_4px_rgba(0,0,0,0.25)]">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-10 mt-2 max-w-6xl w-full mb-20">
                        {infoCards.map((c, i) => {
            const Icon = c.icon;
            return (<Card key={i} className="flex flex-col items-center justify-center px-6 py-4 sm:px-10 sm:py-5
        ...
        }} className="absolute left-[calc(50%-46px)] cursor-pointer bottom-[26px] w-[94px] h-[30px] z-10" alt="Line" src="/images/down_arrow.svg"/>
            ...
            <PopUp isOpen={isPopupOpen} onClose={handleClosePopup} title={"Registration"} subtitle={"Closed for This Season"} msg={"Registration for this season has closed, but great things are ahead! Keep an eye out — we’ll be opening again with fresh opportunities next season."}/>
        </section>);
}

    ...
    return (<div className="space-y-6 animate-fade-in-up">
            ...
            <div className="space-y-6 px-2 md:px-10">
                <div>
                    ...
                    <textarea value={formData.dep1_motiv} onChange={(e) => {
            handleInputChange("dep1_motiv", e.target.value);
            // Auto-resize logic
            e.target.style.height = "auto"; // reset height
            e.target.style.height = e.target.scrollHeight + "px"; // set new height
        }} className="input-style resize-none pr-4 textarea-responsive overflow-hidden text-sm" placeholder="Tell us why you're interested in this department. What excites you about it? Do you have any relevant skills or experience?"/>
                ...
                <div>
                    ...
                    <textarea value={formData.dep2_3_motiv} onChange={(e) => {
            handleInputChange("dep2_3_motiv", e.target.value);
            // Auto-resize logic
            e.target.style.height = "auto"; // reset height
            e.target.style.height = e.target.scrollHeight + "px"; // set new height
        }} className="input-style resize-none textarea-responsive pr-4 overflow-hidden" placeholder="Tell us why you're interested in this department. What excites you about it? Do you have any relevant skills or experience?"/>

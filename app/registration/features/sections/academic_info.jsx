...
export default function AcademicInfo() {
    ...
    return (<div className="space-y-6 animate-fade-in-up">
            <div className="text-center mb-8">
                <img src="/icons/acad.svg" alt="User Icon" className="w-12 h-12 sm:w-16 sm:h-16 md:w-[70px] md:h-[70px] mx-auto mb-4"/>
            ...
            <div className="input-cont">
                <div>
                    ...
                    <input type="text" value={formData.university} onChange={(e) => handleInputChange("university", e.target.value)} className="input-style" placeholder="Your university name" required/>
                ...
                <div>
                    ...
                    <CosmicSelect placeholder="Select your current year" options={yearOptions} value={formData.yearOfStudy} onValueChange={value => handleSelectChange("yearOfStudy", value)} required/>
                ...
                <div>
                    ...
                    <input type="text" value={formData.field} onChange={(e) => handleInputChange("field", e.target.value)} className="input-style" placeholder="Enter your field of study or major" required/>
                ...
                <div>
                    ...
                    <CosmicSelect placeholder="Select the city of your university" options={wilayas} value={formData.university_location} onValueChange={value => handleSelectChange("university_location", value)} required/>
